...
{
    public class TrackedVideoWithSettingsXml
    {
        ...
        [XmlElement(ElementName = "WhiskerSettings")]
        public WhiskerVideoSettingsXml WhiskerSettings
        {
            get;
            set;
        }

        [XmlElement(ElementName = "FootSettings")]
        public FootVideoSettingsXML FootSettings
        {
            get;
            set;
        }
        ...
        public ITrackedVideo GetData()
        {
            ...
            }if(FootSettings != null)
            {
                trackedVideo.FootSettings = FootSettings.getFootVideoSettings();
            }
