...
namespace ArtLibrary.Model.BodyDetection
{
    internal class BodyDetection : ModelObjectBase, IBodyDetection
    {
        ...
        //public void FindBody(Image<Gray, Byte> image, out double waistLength, out double waistVolume, out double waistVolume2, out double waistVolume3, out double waistVolume4, out PointF centroid, out Point[] bodyContour)
        //{
        ...
        //    //using (Image<Gray, Byte> backgroundNot = BinaryBackground.Not())
        //    //using (Image<Gray, Byte> finalImage = binary.Add(backgroundNot))
        //    using (Image<Gray, Byte> final = image.Not())
        ...
        //        CvBlobs blobs = new CvBlobs();
        //        BlobDetector.Detect(final, blobs);
        ...
        //        PointF[] result = headRbsk.FindPointsFromRules(allKeyPoints[0], final, ref prob);
        ...
        //ISkeleton skel = ModelResolver.Resolve<ISkeleton>();
        //        Image<Gray, Byte> tempBinary = final.Clone();
        ...
        //        using (Image<Bgr, Byte> displayImage = final.Convert<Bgr, Byte>())

        //using (Image<Gray, Byte> skelImage = skel.GetSkeleton(binaryRoi))
        //        //using (Image<Bgr, Byte> drawImage = frame.Clone())
        //        using (Image<Bgr, Byte> tempImage2 = new Image<Bgr, byte>(final.Size))
        //        {
        //            //-----------------------------------------
        //            if (SkelImage != null)
        //            {
